export default function Symposium() {
  const symposium = {
    title: "Technical Symposium in Adaptive Manufacturing",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-purple-900 via-purple-800 to-pink-700 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Technical Symposium</h1>
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Join industry experts and academics for insights into the future of adaptive manufacturing.
          </p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            ...
            <div className={`bg-gradient-to-r ${symposium.color} p-8`}>
              <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">{symposium.title}</h3>
              <p className="text-white/80 text-lg">{symposium.description}</p>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="flex items-center text-gray-600">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{symposium.speaker}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{symposium.date}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{symposium.time}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">{symposium.location}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-purple-50 border border-purple-100 rounded-xl p-6 text-center">
                ...
                <p className="text-purple-700 font-medium">
                  Symposium details will be announced soon. Stay tuned!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 bg-white border border-gray-200 rounded-2xl p-8">
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-lg font-bold text-gray-900 mb-2">Interested in our symposium?</h3>
